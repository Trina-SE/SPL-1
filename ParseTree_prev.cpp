...
node main_func(string str){
    ...
    // cout<<"parse-main_func  ";
      ...
      tree[indx].child.push_back("type_spec");
      ...
      newnode.children.push_back({"type_spec", {}});
...
/*void printParseTree(node n, int depth)
{
    ...
    if (n.children.empty())
    {
        ...
        terminals.push_back(n.label);

    }
    cout << string(depth, ' ') <<n.label << endl;
