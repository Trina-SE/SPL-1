...
void lexed() {
    ...
    input_sc.open("sourceCode.txt");
    output_tok.open("Token.txt");
    ...
    if(input_sc.is_open()){
        ...
        if(ch==',' || ch==';' || ch==' ' || ch=='=' || ch=='\n' || ch=='\t' || ch=='('|| ch==')' || ch=='{'|| ch=='}'|| ch=='"'|| ch==']'|| ch=='['|| ch=='+'|| ch=='-'|| ch=='*'|| ch=='/'|| ch=='%'|| ch=='!'|| ch=='<'|| ch=='>'){
            ...
            else if(break_statement(str)==true){
            ...
            else if(return_statement(str)==true){
   ...
   output_tok<<"NO: "<<"  Token"<<"\t\t\t\t"<<"Token_Type"<<"\t\t\t"<<"Token_ID"<<"\n";
   output_tok<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";

   output_tok<<1<<". "<<tok[0].name<<"\t\t\t"<<tok[0].type<<"\t\t\t\t"<<tok[0].id<<"\n";
   ...
   for(int i=1;i<token;i++){
        ...
        if(tok[i].name=="int" && tok[i+1].name=="main"){
            output_tok<<idx<<". "<<"int main"<<"\t\t\t\t\t"<<"main_func"<<"\t\t\t\t"<<"9"<<"\n";
            i++;
            idx++;
            tokens.push_back(9);
            continue;
        ...
        output_tok<<idx<<". "<<tok[i].name<<"\t\t\t\t\t"<<tok[i].type<<"\t\t\t\t"<<tok[i].id<<"\n";
